...
- Judge reads `/schemas/evaluation_criteria/{framework}-evaluation-criteria-v1.0.yaml`
...
2. **Load evaluation_criteria**: `/schemas/evaluation_criteria/{framework}-evaluation-criteria-v1.0.yaml`
...
criteria = load_evaluation_criteria(card["framework"])  # gdpr-evaluation-criteria-v1.0.yaml
...
scenarios/
  ...
  templates/
    scenario-template-v1.2.yaml              # Updated template
...
schemas/
  scenario_card/
    scenario-card-schema-v1.2.md             # Canonical schema
  
  evaluation_criteria/
    gdpr-evaluation-criteria-v1.0.yaml       # Judge reads this
    iso27001-evaluation-criteria-v1.0.yaml   # Phase 1
```
